...
class RealisateurController extends AbstractController
{
    ...
    public function new(Request $request,FileUploader $fileUploader, RealisateurRepository $realisateurRepository): Response
    {
        ...
        if ($photoFile) {
            ...
            $realisateur->setPhoto($photoFile);
        }
    ...
    public function edit(Request $request,FileUploader $fileUploader, Realisateur $realisateur, RealisateurRepository $realisateurRepository): Response
    {
        $form = $this->createForm(RealisateurType::class, $realisateur);
        $form->handleRequest($request);
